...
namespace Lab1.Tests
{
    ...
    public class ExtendedRayTracerTests
    {
        ...
        {
            Assume.That(!System.Diagnostics.Debugger.IsAttached, "���������� ������ ���� �� ��� ������.");
        ...
        public void ConfigFile_Parameters_AreReadCorrectly()
        {
            ...
            Assert.That(maxBounces, Is.EqualTo(3), "�������� MaxRayBounces �� �������� � �������.");
            Assert.That(environment, Is.EqualTo("Test"), "�������� RenderEnvironment �� �������� � �������.");
        }
    }
}